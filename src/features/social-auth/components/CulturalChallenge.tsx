        ...
        <>
          ...
          <button
            ...
            className={cn(
              ...
              (isLoading || remainingAttempts <= 0) && 'opacity-50 cursor-not-allowed'
            )}
          ...
          <p className="text-center text-muted-foreground text-sm">
            {micState === 'idle' && 'Appuie pour répondre'}
            {micState === 'listening' && "Je t'écoute..."}
            {micState === 'processing' && 'Vérification...'}
          </p>
